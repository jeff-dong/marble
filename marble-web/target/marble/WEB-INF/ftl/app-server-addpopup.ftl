        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="alert">
                    ...
                    <strong>提示：</strong>在服务器IP地址和SOA的应用名称+应用NameSpace同时存在情况下，优先利用SOA信息动态获取集群的IP地址
                ...
                <form class="form-horizontal" id="jq-validation-server-form" novalidate="novalidate">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="servergroup-div"
                                       name="jq-validation-servergroup" placeholder="服务器组" value="DEFAULT">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="servername-div"
                                       name="jq-validation-servername" placeholder="服务器名称"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="serverip-div" name="jq-validation-serverip"
                                       placeholder="服务器IP">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" id="serverdesc-div" name="jq-validation-serverdesc"
                                          placeholder="服务器描述信息"></textarea>
                            </div>
                        </div>
                        <div class="form-group">

<script>
    ...
    init.push(function () {
        $("#addNewApp-btn").click(function () {
            ...
            var soaName = $("#soaservicename-div").val();
            var soaNamespace = $("#soaservicenamespace-div").val();
            ...
            $.ajax({
                ...
                "data": {
                    ...
                    "description": appDesc,
                    "owner": appOwner,
                    "marbleVersion": marVersion,
                    "soaServiceName": soaName,
                    "soaServiceNameSpace": soaNamespace
                },
                "type": "POST",
                "error": function () {
                },
                ...
                <form class="form-horizontal" id="jq-validation-app-form" novalidate="novalidate">
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="appcode-div" name="jq-validation-appcode"
                                       placeholder="AppCode">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="appname-div" name="jq-validation-appname"
                                       placeholder="应用名称">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" id="appdesc-div" name="jq-validation-appdesc"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="appowner-div" name="jq-validation-appowner"
                                       placeholder="拥有者的员工号">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="marbleversion-div"
                                       name="jq-validation-version" placeholder="输入使用的Marble版本号">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <span type="text" class="form-control"
                                      style="background: #eee;border: none;">初始状态（可用）</span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="soaservicename-div"
                                       name="jq-validation-soaservicename" placeholder="SOA服务名">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="jq-validation-soaservicenamespace"
                                   class="col-sm-2 control-label">SOA服务NameSpace</label>

                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="soaservicenamespace-div"
                                       name="jq-validation-soaservicenamespace" placeholder="SOA服务NameSpace">
                            </div>
                        </div>
                    </div>
                </form>
